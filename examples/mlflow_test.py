...
os.environ["MLFLOW_S3_ENDPOINT_URL"] = "http://127.0.0.1:40905" # api 9000
os.environ["AWS_ACCESS_KEY_ID"] = "minio"
os.environ["AWS_SECRET_ACCESS_KEY"] = "minio123"
# os.environ["ARTIFACT_STORE_LOCATION"] = "s3://mlflow" not needed
mlflow.set_tracking_uri("http://127.0.0.1:40657") # ui 5000
def read_lines(path):
    with open(path) as f:
